  ...
  const handleCategorySelect = (category) => {
    ...
    const handleNextQuestion = () => {
      ...
      if (isLastQuestion) {
        ...
        const currentQuestion = selectedCategory.questions[currentQuestionIndex];
        // Son sorunun doğru cevabı seçilirse, skoru bir artırarak final skoru hesapla.
        ...
        <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center text-center p-4">
          <div className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-lg">
              ...
              <p className="text-slate-600 dark:text-slate-300">
                  Quiz verileri yüklenemedi. Lütfen `src` veya `public` klasöründe `quizzes.json` dosyasının olduğundan emin olun.
              </p>
          </div>
        </div>
      );
